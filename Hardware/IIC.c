...
#define RCC_IIC_ENABLE      RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE); /* GPIO端口时钟 */
...
#define IIC_SDA_READ  	 	PBin(9)        /* 读SDA口线状态 */
#define GPIO_PIN_SET        1
#define GPIO_PIN_RESET      0
#define IIC_SCL_1()  IIC_SCL = 	GPIO_PIN_SET	/* SCL = 1 */
#define IIC_SCL_0()  IIC_SCL =	GPIO_PIN_RESET	/* SCL = 0 */

#define IIC_SDA_1()  IIC_SDA = 	GPIO_PIN_SET	/* SDA = 1 */
#define IIC_SDA_0()  IIC_SDA = 	GPIO_PIN_RESET	/* SDA = 0 */
